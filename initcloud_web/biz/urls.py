...
from biz.order_heat import views as order_heat_view
from biz.alarm import views as alarm_view
from biz.UserGrouper import views as user_grouper_view
from biz.service_grant import views as service_grant_view
from biz.myapp import views as myapp_view
from biz.deployapp import views as deployapp_view
from biz.swift import views as swift_view
...
#virtualmechine_bar
urlpatterns += [
    #url(r'^virtualmechine_bar/$', user_grouper_view.update_UserGrouper),
    url(r'^virtualmechine_bar/$', virtualmechine_view.Virtualmechine_BarList.as_view()),
]
...
#myapp
urlpatterns += [
    url(r'^myapp/$', myapp_view.MyappList.as_view()),
]


#deployapp
urlpatterns += [
    url(r'^deployapp/$', deployapp_view.DeployappList.as_view()),
    url(r'^deployapp/update/$', deployapp_view.deployapp_update),
...
urlpatterns += format_suffix_patterns([
    ...
    url(r'^images/filter/$', image_view.filter_image),
    url(r'^images/batch-delete/$', image_view.delete_images),
])

# service_grant
urlpatterns += format_suffix_patterns([
    url(r'^service_grant/$', service_grant_view.Service_GrantList.as_view()),
    url(r'^images/(?P<pk>[0-9]+)/$', image_view.ImageDetail.as_view()),
    url(r'^images/create/$', image_view.create_image),
    url(r'^service_grant/update/$', service_grant_view.update_service_grant),
    url(r'^service_grant/params/(?P<order_heat_id>[0-9]+)/$', service_grant_view.get_params),
    url(r'^service_grant/batch-delete/$', service_grant_view.delete_service_grants),
])
# network
urlpatterns += format_suffix_patterns([
...
#order_heat
urlpatterns += [
    url(r'^order_heat/$', order_heat_view.Order_HeatList.as_view()),
    url(r'^order_heat/params/(?P<heat_id>[0-9]+)/$', order_heat_view.get_params),
    url(r'^order_heat/details/(?P<heat_id>[0-9]+)/$', order_heat_view.detail_order_heat.as_view()),
    url(r'^order_heat/update/$', order_heat_view.update_order_heat),
    url(r'^application/(?P<stack_id>[^/]+)/$', order_heat_view.application.as_view()),
    url(r'^order_heat/create/$', order_heat_view.create_order_heat),
    url(r'^order_heat/batch-delete/$', order_heat_view.delete_order_heats),
]

#swift
urlpatterns += [
    url(r'^swift/$', swift_view.SwiftList.as_view()),
#    url(r'^order_heat/update/$', order_heat_view.update_order_heat),
    url(r'^swift/create/$', swift_view.create_swift),
    url(r'^swift/batch-delete/$', swift_view.delete_swifts),
    url(r'^swift_folder/$', swift_view.SwiftObjectList.as_view()),
    #url(r'^swift_folder/$', swift_view.swift_folder_view),
    url(r'^swift_folder/upload/$', swift_view.upload_object),
    url(r'^swift_folder/download/$', swift_view.download_object),
    url(r'^swift_folder/create/$', swift_view.create_swift_folder),
    url(r'^swift_folder/batch-delete/$', swift_view.delete_swifts_folders),
]
